<template lang="">
    <v-container class="withdrawalContainer">
        <div class="withdrawalForm">
            ...
            <div class="infomenu">
                <span class="mdi mdi-checkbox-marked-outline">
                    <strong> 사용하고 계신 아이디는 탈퇴할 경우 복구가 불가합니다.</strong>
                </span><br>
            ...
            <div class="final">
                <v-alert
                    ...
                    color=red
                >
                탈퇴 후에는 현재 계정의 데이터를 <strong>복구</strong>할 수 없습니다.
                </v-alert>
                <v-checkbox
                    v-model="agree"
    ...
    methods: {
        ...
        async withdrawalBtn () {
            ...
            if(this.agree == true && this.password === '') {
                alert("비밀번호를 입력해주세요.")
            } else if(this.agree == true && this.password != null) {
